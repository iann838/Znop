...
0. Make sure to have python > v3.6
1. Find the latest source code in this repository's [Releases](https://github.com/paaksing/Znop/releases).
...
0. Make sure to have python > v3.6 installed and git installed.
